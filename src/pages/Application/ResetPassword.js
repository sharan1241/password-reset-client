        ...
        <div className='card' style={{width:"400px"}}>
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="confirm email" value={form['email']} onChange={handleInputChange}/>
                </div>
                <div class="mb-3">
                    <label for="pass" class="form-label">enter new Password</label>
                    <input type="password" class="form-control" id="pass" placeholder="enter new password" value={form['pass']} onChange={handleInputChange}/>
                </div>
                <div class="d-grid">
                    <button class="btn btn-primary" type="button" onClick={handleFormSubmit}>submit</button>                </div>
            </div>
        </div>
    </section>
  )
