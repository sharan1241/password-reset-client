        ...
        <div className='card' style={{width:"400px"}}>
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="enter email" value={form['email']} onChange={handleInputChange}/>
                </div>
                <div class="d-grid">
                    <button class="btn btn-primary" type="button" onClick={handleFormSubmit}>Login</button>                </div>
            </div>
        </div>
    </section>
  )
